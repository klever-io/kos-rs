...
impl CTxInfo {
    ...
    pub fn to_tx_info(&self) -> TxInfo {
        TxInfo {
            sender: String::from_utf8(self.read_sender()).unwrap_or_else(|_| String::new()),
            receiver: String::from_utf8(self.read_receiver()).unwrap_or_else(|_| String::new()),
            value: self.value,
