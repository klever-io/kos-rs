...
mod tests {
    use crate::models::{
        ...
        new_evm_transaction_options, new_icp_wallet_options, new_substrate_transaction_options,
    };
    use crate::*;
    ...
    fn should_fail_to_generate_mnemonic() {
        ...
        match generate_mnemonic(size) {
            ...
            Err(e) => assert_eq!(e, KOSError::kos_delegate("invalid mnemonic".to_string())),
        }
    }
    ...
    fn should_fail_to_get_account_from_mnemonic_with_invalid_chain() {
        ...
        match generate_wallet_from_mnemonic(mnemonic, chain_id, index, None) {
            ...
            Err(e) => assert_eq!(
                e,
                KOSError::unsupported_chain(chain_id.to_string()),
                "Expected UnsupportedChainError but found different error"
            ),
        }
    }
    ...
    fn should_fail_to_decrypt_with_wrong_password() {
        ...
        match decrypt(encrypted_data, "wrong".to_string(), ITERATIONS) {
            ...
            Err(e) => assert_eq!(
                e,
                KOSError::kos_delegate("cipher error: decryption failed: aead::Error".to_string())
            ),
        }
    }

    #[test]
    fn should_sign_transaction_klv() {
        let chain_id = 38;
    ...
    #[test]
    fn should_sign_transaction_trx() {
        let chain_id = 1;
    ...
    #[test]
    fn should_sign_transaction_iota() {
        let chain_id = 69;
        ...
        assert_eq!(transaction.signature, "0005f770aee829e547f3de76b1a5aaf762227fac4a097e638d57060108140507b65328db581bc617e500b27c39fbae85e91be92280d95b2f031259d2915183440d931c54b678837cf96a49ee1d1122027fabadf0aee97d9f9094187db8be396f63", "The signature doesn't match");
    }

    #[test]
    fn should_sign_transaction_sol() {
        let chain_id = 40;
    ...
    #[test]
    fn should_sign_legacy_transaction_sol() {
        let chain_id = 40;
    ...
    #[test]
    fn should_sign_v0_transaction_sol() {
        let chain_id = 40;
    ...
    #[test]
    fn should_sign_transaction_cosmos() {
        let chain_id = 48;
        let account =
            generate_wallet_from_mnemonic(get_test_mnemonic().to_string(), chain_id, 0, None)
                .unwrap();
        ...
        Some(new_cosmos_transaction_options("celestia".to_string(), 274454)),
    )
    .unwrap();
    ...
    #[test]
    fn should_sign_transaction_bch() {
        let chain_id = 18;
        let account =
            generate_wallet_from_mnemonic(get_test_mnemonic(), chain_id, 0, None).unwrap();
        let transaction = sign_transaction(
        ...
        Some(new_bitcoin_transaction_options(
            vec![498870, 1001016],
            vec![
    ...
    #[test]
    fn should_sign_transaction_btc() {
    ...
    #[test]
    fn should_sign_transaction_dash() {
        let chain_id = 11;
        let account =
            generate_wallet_from_mnemonic(get_test_mnemonic(), chain_id, 0, None).unwrap();
        let transaction = sign_transaction(
    ...
    #[test]
    fn should_sign_transaction_doge() {
        let chain_id = 12;
    ...
    #[test]
    fn should_sign_transaction_dot() {
        let chain_id = 21;
        let account =
            generate_wallet_from_mnemonic(get_test_mnemonic(), chain_id, 0, None).unwrap();
        let options = new_substrate_transaction_options(
            "0a0300b8c8ac77e723fae060f2dc70d00a591e1127ec07e0e81e2237a823cbe5210d1e02286bee"
                .to_string(),
            "0501".to_string(),
            6,
            0,
            Some("0".to_string()),
            "781cf57533b15a5a13729a33543fd6ae137bce54ef14eb933b0a4813489e7e0a".to_string(),
            "68d56f15f85d3136970ec16946040bc1752654e906147f7e43e9d539d7c3de2f".to_string(),
            2000002,
            15,
            None,
            None,
    ...
    #[test]
    fn should_sign_transaction_icp() {
        let chain_id = 31;
    ...
    #[test]
    fn should_sign_transaction_xlm() {
        let chain_id = 6;
